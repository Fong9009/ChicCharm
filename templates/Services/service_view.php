...
?>
<div style="background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('<?= $imageServicePath ?>') center center / cover no-repeat;">
    <div class="row p-2  justify-content-start ms-2">
        <div class="col-lg-2">
            <?= $this->Html->link(
                '<i class="fa fa-arrow-left"></i> ' . __('Back To Services'),
                ['controller' => 'services', 'action' => 'service-page'],
                ['class' => 'btn btn-primary', 'style' =>"background-color: orange", 'escape' => false]
            ) ?>
        </div>
    </div>
    <div class="row p-2 justify-content-center">
        <div class="col-lg-8 text-center">
            ...
            <h2 class="fw-bold text-white"><?= $serviceInQuestion->service_name ?></h2>
            <h3 class="text-white"> <?= $this->ContentBlock->text('service-page-stylist-description'); ?></h3>
