                                ...
                                <td class="actions">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li><?= $this->Form->postLink(__('Restore'), ['action' => 'restore', $contact->id], ['confirm' => __('Are you sure you want to restore this message?'), 'class' => 'dropdown-item restore']) ?></li>
                                            <li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $contact->id], ['confirm' => __('Are you sure you want to delete # {0}?', $contact->id), 'class' => 'dropdown-item delete']) ?></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
