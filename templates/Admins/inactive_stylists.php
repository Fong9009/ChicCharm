 ...
 * @var iterable<\App\Model\Entity\Stylist> $inactiveStylists
 */
                    ...
                    <?= $this->Html->link(
                        '<div class="card h-100">
                            <div class="card-header new-card-header d-flex justify-content-between align-items-center flex-wrap">
                                <h4 class="view-card-h4 mb-0 flex-grow-1 text-truncate">Active Stylists</h4>
                                <i class="material-icons view-icon ms-2">people</i>
                            </div>
                            <div class="card-body new-card-body"></div>
                            <div class="card-footer new-card-footer">
                                <span class="mb-0 text-truncate">View Active Stylists</span>
                            </div>
                        </div>',
    ...
    <div class="table-responsive mt-3">
        <div class="container">
            <div class="row align-items-center">
                <h3><?= __('Inactive Stylist Accounts') ?></h3>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                <?php foreach ($inactiveStylists as $stylist): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(
                            __('Restore'),
                            ['action' => 'restoreStylist', $stylist->id],
                            [
                                'confirm' => __('Are you sure you want to restore # {0}?', ($stylist->first_name . ' ' . $stylist->last_name)),
                                'class' => 'button btn-success'
                            ]
                        ) ?>
                        <?= $this->Form->postLink(
                            __('Delete Permanently'),
                            ['action' => 'hardDeleteStylist', $stylist->id],
                            [
                                'confirm' => __('Are you sure you want to permanently delete # {0}? This cannot be undone.', ($stylist->first_name . ' ' . $stylist->last_name)),
